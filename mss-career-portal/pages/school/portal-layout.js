...
(function () {
  ...
  const PORTAL_ROLES = {
    ...
    hr: {
      ...
      navItems: [
        ...
        { label: 'Job Posts', icon: 'clipboard-list', href: '/mss-career-portal/hr/jobpost-list', pages: ['hr-jobpost-list.html', 'hr-jobpost-create.html', 'hr-jobpost-details.html', 'jobpost-list', 'jobpost-create', 'jobpost-details'], badge: '' },
        { label: 'Job Applicants', icon: 'users', href: '/mss-career-portal/hr/jobapplicants-list', pages: ['hr-jobapplicants-list.html', 'hr-candidate-profile.html', 'jobapplicants-list', 'candidate-profile'], badge: '' },
  ...
  const NOTIFICATIONS = {
    candidate: [
      { id: 1, title: 'Application Reviewed', message: 'Your Math Teacher application moved to profile review.', time: '10 min ago', read: false },
      { id: 2, title: 'Interview Scheduled', message: 'A school interview is booked for today at 3:30 PM.', time: 'Today', read: false },
      { id: 3, title: 'New Job Match', message: 'Senior English Teacher is now open for applications.', time: 'Today', read: false },
      { id: 4, title: 'Offer Update', message: 'One offer is waiting for your response.', time: 'Yesterday', read: true },
      { id: 5, title: 'Profile Reminder', message: 'Complete your profile to improve matching.', time: '2 days ago', read: false },
      { id: 6, title: 'Document Request', message: 'Upload updated certificates when available.', time: 'Last week', read: true }
    ],
    hr: [
      { id: 1, title: 'New Application', message: 'Priya Sharma applied for Mathematics Teacher.', time: '5 min ago', read: false },
      { id: 7, title: 'AO Approved', message: 'Appointment Order approved for Arun Kumar.', time: '5 min ago', read: false },
      { id: 2, title: 'Interview Scheduled', message: 'Interview scheduled successfully for Arun Kumar at 3:00 PM.', time: '15 min ago', read: false },
      { id: 4, title: 'MASSET Sync Failed', message: 'Employee onboarding sync failed. Retry required.', time: 'Today', read: false },
      { id: 3, title: 'AO Request for the candidate Magizh', message: 'school admin requested Apointment Order for the candidate magizh', time: '1 hour ago', read: true },
      { id: 5, title: 'Feedback Submitted', message: 'School Admin submitted Round 2 feedback.', time: 'Today', read: true },
      { id: 6, title: 'AO Approval Pending', message: 'Appointment Order approval pending in MASSET.', time: 'Yesterday', read: false }
    ],
    schoolAdmin: [
      { id: 1, title: 'Interview rescheduled', message: 'Interview with Arun Kumar rescheduled to 4:00 PM.', time: '10 min ago', read: false },
      { id: 2, title: 'Interview Scheduled', message: 'Interview scheduled for English teacher interview at 4:00 PM.', time: '15 min ago', read: false },
      { id: 3, title: 'Offer Accepted', message: 'Candidate accepted the offer letter.', time: '1 hour ago', read: false },
      { id: 4, title: 'Offer Rejected', message: 'Candidate rejected the offer letter.', time: '2 hours ago', read: false },
      { id: 5, title: 'Feedback Submitted', message: 'HR submitted Round 1 feedback for Arun Kumar.', time: 'Today', read: true },
      { id: 6, title: 'Request to HR for AO for the candidate Priya Sharma', message: 'Please process AO for the candidate Priya Sharma.', time: 'Yesterday', read: false }
    ]
  };
