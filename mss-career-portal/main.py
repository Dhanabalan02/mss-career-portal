...
@app.get("/mss-career-portal/open-roles")
...
@app.get("/mss-career-portal/applied-jobs")
def redirect_short_applied_jobs():
    return serve_html_with_base("mss-career-portal/pages/candidate/applied-jobs.html", "/mss-career-portal/pages/candidate/")
